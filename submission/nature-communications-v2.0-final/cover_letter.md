...
**To:** Editor-in-Chief, *Nature Communications*  
**From:** Demetrios C. Agourakis  
**Date:** November 8, 2025  
**Subject:** Manuscript Submission - "Boundary Conditions for Hyperbolic Geometry in Semantic Networks"
...
This manuscript aligns perfectly with *Nature Communications*' scope, combining rigorous network analysis, cognitive science applications, and methodological innovation. The structural null model approach addresses recent methodological debates in network science, while the cross-linguistic cognitive focus connects to the journal's interdisciplinary mission. Our findings have implications for network geometry theory, cognitive network modeling, computational linguistics, and clinical biomarkers for semantic disorders.
...
If semantic memory's fundamental geometry is hyperbolic within specific boundary conditions, this has theoretical implications for hierarchical memory models, validates hyperbolic embedding approaches in NLP, and suggests novel biomarkers for semantic disorders where network geometry might be disrupted. The finding that geometry persists independently of strict scale-free topology advances network geometry theory more broadly.
...
4. **Dr. Chien-Chung Ni** (Meta AI Research)  
   ...
   Expertise: Ollivier–Ricci curvature, GraphRicciCurvature library  
   Rationale: Developer of the primary curvature computation tool used in this work

5. **Dr. Danielle S. Bassett** (University of Pennsylvania)  
   Email: dsb@seas.upenn.edu  
   Expertise: Network neuroscience, cognitive biomarkers  
   Rationale: Expert on network-based clinical biomarkers
...
Thank you for considering our manuscript. I believe it makes significant methodological and theoretical contributions to network science, cognitive network analysis, and computational linguistics. I look forward to your feedback and the review process.
...
**Attachments:**
1. Main manuscript (PDF) – v2.0
2. Supplementary materials (PDF)
3. Figure files (high-resolution PNG/PDF)
4. Data availability statement
5. Code repository link (GitHub + Zenodo DOI: 10.5281/zenodo.17531773)
