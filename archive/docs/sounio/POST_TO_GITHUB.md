# Instructions for Posting GitHub Issue
...
**Title**:
```
Network Geometry Module Implementation - stdlib/graph with Ollivier-Ricci Curvature
```
...
**Body**:
Copy the entire contents of `GITHUB_ISSUE_DRAFT.md`
...
You can reference the issue when:
- Testing the code and finding errors
...
**The issue is ready to post whenever you are!** 🚀

It's comprehensive but organized, technical but accessible, and asks concrete questions while showing real implementation work.
