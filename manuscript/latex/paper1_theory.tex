...
\bibitem{paper2}
D.~C.~Agourakis and M.~Gerenutti, ``Cross-linguistic geometry of semantic networks: A curvature phase transition theory with LLM validation,'' PsyArXiv preprint, 2026.
