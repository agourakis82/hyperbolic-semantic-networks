...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{../../figures/phase10/figure10_1_orbit_trajectories.pdf}
\hfill
\includegraphics[width=0.48\textwidth]{../../figures/phase10/figure10_2_zero_div_proximity.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{../../figures/phase10/figure10_3_hessian_symmetry.pdf}
\hfill
\includegraphics[width=0.48\textwidth]{../../figures/phase10/figure10_4_feature_correlation.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{../../figures/phase10/figure10_7_escape_map.pdf}
\hfill
\includegraphics[width=0.48\textwidth]{../../figures/phase10/figure10_8_discriminability_eta.pdf}
...
``A finite-size crossover in Ollivier--Ricci curvature of random regular graphs,''
\emph{Authorea preprint}, 2026.

\bibitem{agourakis2026semantic}
D.~C.~Agourakis and M.~Gerenutti,
``Cross-linguistic geometry of semantic networks: A curvature phase transition theory with LLM validation,''
\emph{PsyArXiv preprint}, 2026.
