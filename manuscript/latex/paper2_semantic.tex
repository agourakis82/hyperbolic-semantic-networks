...
SWOW Dutch & 500 & 61 & $+0.069 \pm 0.000$ & $+0.099$ & $+0.029$ & $+0.076$ \\
...
\multicolumn{7}{@{}l}{\footnotesize Config model values are preliminary (computation ongoing for remaining networks).}
\end{tabular}
\end{table}
